...
public class SecretRoom extends Room {
    ...
    public SecretRoom(String name, String description, Floor floor, Door door, Map<String, Item> contents, Function<Inventory, Boolean> isVisible) {
        super(name, description, floor, door, contents);

        this.isVisible = isVisible;
    }

    public SecretRoom(String name, String description, Stairs stairs, Floor floor, Door door, Map<String, Item> contents, Function<Inventory, Boolean> isVisible) {
