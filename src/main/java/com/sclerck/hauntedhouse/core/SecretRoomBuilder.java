...
public class SecretRoomBuilder {
    ...
    public static SecretRoom build(String name, String description, Floor upFloor, Floor thisFloor, boolean lockedDoor, Colour colour, Map<String, Item> contents, Function<Inventory, Boolean> isVisible) {
    ...
    public static SecretRoom build(String name, String description, Floor thisFloor, boolean lockedDoor, Colour colour, Map<String, Item> contents, Function<Inventory, Boolean> isVisible) {
